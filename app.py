...
# --- THE MASTER CONFIGURATION ---
# Paste your "Publish to Web" CSV link here
PUBLISH_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRv9ombwUlAaUU1-5rbkKeASVPN27FBzwc4T4x1be0EMMwfC-burrR6SJ7JUGxa6pDa1ifWhx1_HuML/pubhtml"
...
if page == "✂️ Daily Data Entry":
    ...
    with st.form("cutting_form", clear_on_submit=True):
        ...
        if submitted:
            ...
            st.link_button("💾 Open Google Sheet to Save", PUBLISH_URL.split('/pub?')[0].replace('/e/', '/d/') + '/edit')
    ...
    if not df.empty:
        # We search for the correct columns even if they are lowercase
